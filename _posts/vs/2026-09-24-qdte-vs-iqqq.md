...
layout: single
title: QDTE vs IQQQ
excerpt: QDTE의 최근 2년 6개월 CAGR은 21.6%로 IQQQ의 18.5%보다 3.1% 높았습니다.
header:
  overlay_color: "#333"
...
**수익률 지표 (CAGR):** QDTE의 CAGR은 21.6%로 IQQQ의 18.5%보다 3.1% 높았습니다. (높은 수익률)[^fn_vs_comp]

**위험도 지표 (표준편차):** QDTE의 표준편차는 18.9%로 IQQQ의 18.9%와 비슷했습니다. (비슷한 위험도)
...
**위험도 지표 (표준편차):** 표준편차를 동일한 값으로 맞추기 위해서는 18.9% / 18.9% = 100% 비중으로 투자하면 됩니다.[^fn_vs_sharpe]
...
**위험도 지표 (MDD):** 112% 투자 비중으로 하여 MDD를 비슷한 수준으로 맞추면, CAGR은 20.6%로 QDTE의 21.6%와 비슷했습니다. (비슷한 수익률)
