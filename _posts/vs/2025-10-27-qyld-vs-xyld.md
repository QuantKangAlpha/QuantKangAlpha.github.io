...
| XYLD | <span style="color: tomato">7.3<small>%</small></span> | 14.0<small>%</small> | 0.52 | -33.5<small>%</small> | -4.0<small>%</small> |
...
**위험도 지표 (표준편차):** QYLD의 표준편차는 14.9%로 XYLD의 14.0%와 비슷했습니다. (비슷한 위험도)
...
**위험도 지표 (표준편차):** 표준편차를 동일한 값으로 맞추기 위해서는 14.0% / 14.9% = 107% 비중으로 투자하면 됩니다.[^fn_vs_sharpe]
...
이 포트폴리오는 QYLD의 7.8%보다 -1.2% 낮았습니다.
