...
layout: single
title: SPY vs IDVO
excerpt: SPY의 최근 3년 CAGR은 19.7%로 IDVO의 20.7%와 비슷했습니다.
header:
  overlay_color: "#333"
...
**수익률 지표 (CAGR):** SPY의 CAGR은 19.7%로 IDVO의 20.7%와 비슷했습니다. (비슷한 수익률)[^fn_vs_comp]
...
| IDVO<sub>MDD</sub> <small>(121%)</small> | <span style="color: tomato">25.2<small>%</small></span> | 19.5<small>%</small> | 1.29 | -18.5<small>%</small> | -2.9<small>%</small> |



각각의 경우를 SPY의 성과와 비교해 봅니다.

**위험도 지표 (표준편차):** 105% 투자 비중으로 표준편차를 비슷한 수준으로 맞추면, CAGR은 21.7%로 SPY의 19.7%보다 2.0% 높았습니다. (높은 수익률)
