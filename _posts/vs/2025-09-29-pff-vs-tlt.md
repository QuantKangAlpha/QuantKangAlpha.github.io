...
layout: single
title: PFF vs TLT
excerpt: PFF의 최근 18년 6개월 CAGR은 3.9%로 TLT의 3.2%와 비슷했습니다.
header:
  overlay_color: "#333"
...
**수익률 지표 (CAGR):** PFF의 CAGR은 3.9%로 TLT의 3.2%와 비슷했습니다. (비슷한 수익률)[^fn_vs_comp]
...
**위험도 지표 (표준편차):** 124% 투자 비중으로 표준편차를 비슷한 수준으로 맞추면, CAGR은 3.6%로 PFF의 3.9%와 비슷했습니다. (비슷한 수익률)
