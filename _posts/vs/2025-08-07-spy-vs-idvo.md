...
layout: single
title: SPY vs IDVO
excerpt: SPY의 최근 2년 10개월 CAGR은 18.7%로 IDVO의 18.6%와 비슷했습니다.
header:
  overlay_color: "#333"
...
**수익률 지표 (CAGR):** SPY의 CAGR은 18.7%로 IDVO의 18.6%와 비슷했습니다. (비슷한 수익률)[^fn_vs_comp]
...
| IDVO<sub>MDD</sub> <small>(121%)</small> | <span style="color: tomato">22.6<small>%</small></span> | 19.8<small>%</small> | 1.15 | -18.5<small>%</small> | -3.0<small>%</small> |



각각의 경우를 SPY의 성과와 비교해 봅니다.

**위험도 지표 (표준편차):** 105% 투자 비중으로 표준편차를 비슷한 수준으로 맞추면, CAGR은 19.6%로 SPY의 18.7%와 비슷했습니다. (비슷한 수익률)

**위험도 지표 (MDD):** 121% 투자 비중으로 하여 MDD를 비슷한 수준으로 맞추면, CAGR은 22.6%로 SPY의 18.7%보다 3.9% 높았습니다. (높은 수익률)
...
이 포트폴리오는 SPY의 18.7%보다 2.4% 높았습니다.
