...
| :------------ | ------: | -----------: | -------: | ------: | -------: |
| TIGER 200커버드콜OTM | <span style="color: tomato">2.1<small>%</small></span> | 14.5<small>%</small> | 0.15 | -37.4<small>%</small> | -10.2<small>%</small> |
...
**위험도 지표 (표준편차):** 88% 투자 비중으로 표준편차를 비슷한 수준으로 맞추면, CAGR은 3.6%로 TIGER 200커버드콜OTM의 2.1%보다 1.5% 높았습니다. (높은 수익률)
