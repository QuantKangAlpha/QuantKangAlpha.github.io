...
excerpt: KIWOOM 미국달러SOFR금리액티브(합성) (460270)의 최근 2년 4개월 CAGR은 9.9%로 TIGER 미국달러SOFR금리액티브(합성) (456610)의 9.9%와 비슷했습니다.
header:
  overlay_color: "#333"
...
| :------------ | ------: | -----------: | -------: | ------: | -------: |
| KIWOOM 미국달러SOFR금리액티브(합성) | <span style="color: tomato">9.9<small>%</small></span> | 9.0<small>%</small> | 1.10 | -8.0<small>%</small> | -2.1<small>%</small> |
...
**수익률 지표 (CAGR):** KIWOOM 미국달러SOFR금리액티브(합성)의 CAGR은 9.9%로 TIGER 미국달러SOFR금리액티브(합성)의 9.9%와 비슷했습니다. (비슷한 수익률)[^fn_vs_comp]
...
**위험도 지표 (표준편차):** 103% 투자 비중으로 표준편차를 비슷한 수준으로 맞추면, CAGR은 10.3%로 KIWOOM 미국달러SOFR금리액티브(합성)의 9.9%와 비슷했습니다. (비슷한 수익률)

**위험도 지표 (MDD):** 98% 투자 비중으로 하여 MDD를 비슷한 수준으로 맞추면, CAGR은 9.8%로 KIWOOM 미국달러SOFR금리액티브(합성)의 9.9%와 비슷했습니다. (비슷한 수익률)
...
이 포트폴리오는 KIWOOM 미국달러SOFR금리액티브(합성)의 9.9%와 비슷했습니다.
