...
layout: single
title: GLD vs SPY
excerpt: GLD의 최근 20년 9개월 CAGR은 10.1%로 SPY의 10.5%와 비슷했습니다.
header:
  overlay_color: "#333"
...
**수익률 지표 (CAGR):** GLD의 CAGR은 10.1%로 SPY의 10.5%와 비슷했습니다. (비슷한 수익률)[^fn_vs_comp]
...
**위험도 지표 (표준편차):** 92% 투자 비중으로 표준편차를 비슷한 수준으로 맞추면, CAGR은 9.7%로 GLD의 10.1%와 비슷했습니다. (비슷한 수익률)
