...
| SPY | <span style="color: tomato">18.1<small>%</small></span> | 16.8<small>%</small> | 1.07 | -24.5<small>%</small> | -4.7<small>%</small> |
...
**위험도 지표 (표준편차):** 63% 투자 비중으로 표준편차를 비슷한 수준으로 맞추면, CAGR은 11.4%로 JEPI의 11.3%와 비슷했습니다. (비슷한 수익률)

**위험도 지표 (MDD):** 56% 투자 비중으로 하여 MDD를 비슷한 수준으로 맞추면, CAGR은 10.1%로 JEPI의 11.3%보다 -1.2% 낮았습니다. (낮은 수익률)
