...
**위험도 지표 (표준편차):** XYLD의 표준편차는 13.5%로 SPY의 16.8%보다 -3.4% 낮았습니다. (낮은 위험도)
...
**위험도 지표 (표준편차):** 표준편차를 동일한 값으로 맞추기 위해서는 16.8% / 13.5% = 80% 비중으로 투자하면 됩니다.[^fn_vs_sharpe]
...
| SPY<sub>MDD</sub> <small>(99%)</small> | <span style="color: tomato">14.6<small>%</small></span> | 16.7<small>%</small> | 0.87 | -33.5<small>%</small> | -3.7<small>%</small> |
