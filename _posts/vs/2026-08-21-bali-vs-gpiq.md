...
layout: single
title: BALI vs GPIQ
excerpt: BALI의 최근 2년 9개월 CAGR은 23.9%로 GPIQ의 26.8%보다 -2.9% 낮았습니다.
header:
  overlay_color: "#333"
...
**위험도 지표 (표준편차):** BALI의 표준편차는 12.8%로 GPIQ의 18.0%보다 -5.2% 낮았습니다. (낮은 위험도)
...
**위험도 지표 (표준편차):** 표준편차를 동일한 값으로 맞추기 위해서는 18.0% / 12.8% = 71% 비중으로 투자하면 됩니다.[^fn_vs_sharpe]
...
**위험도 지표 (표준편차):** 71% 투자 비중으로 표준편차를 비슷한 수준으로 맞추면, CAGR은 18.8%로 BALI의 23.9%보다 -5.1% 낮았습니다. (낮은 수익률)

**위험도 지표 (MDD):** 79% 투자 비중으로 하여 MDD를 비슷한 수준으로 맞추면, CAGR은 21.0%로 BALI의 23.9%보다 -3.0% 낮았습니다. (낮은 수익률)
