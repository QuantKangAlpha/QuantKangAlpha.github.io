...
layout: single
title: BALI vs SPYI
excerpt: BALI의 최근 2년 CAGR은 22.3%로 SPYI의 19.5%보다 2.8% 높았습니다.
header:
  overlay_color: "#333"
...
| SPYI | <span style="color: tomato">19.5<small>%</small></span> | 13.2<small>%</small> | 1.48 | -16.5<small>%</small> | -1.4<small>%</small> |
...
**위험도 지표 (표준편차):** BALI의 표준편차는 13.5%로 SPYI의 13.2%와 비슷했습니다. (비슷한 위험도)
...
**위험도 지표 (표준편차):** 표준편차를 동일한 값으로 맞추기 위해서는 13.2% / 13.5% = 102% 비중으로 투자하면 됩니다.[^fn_vs_sharpe]
...
SPYI의 투자 비중을 조절하여 표준편차나 MDD를 동일하게 맞추면, CAGR이 평균 19.9%인 포트폴리오를 만들 수 있습니다.
