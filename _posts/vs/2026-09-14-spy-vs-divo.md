...
layout: single
title: SPY vs DIVO
excerpt: SPY의 최근 9년 9개월 CAGR은 15.0%로 DIVO의 12.7%보다 2.3% 높았습니다.
header:
  overlay_color: "#333"
...
**위험도 지표 (표준편차):** SPY의 표준편차는 18.1%로 DIVO의 14.6%보다 3.4% 높았습니다. (높은 위험도)
...
**위험도 지표 (표준편차):** 표준편차를 동일한 값으로 맞추기 위해서는 14.6% / 18.1% = 123% 비중으로 투자하면 됩니다.[^fn_vs_sharpe]
