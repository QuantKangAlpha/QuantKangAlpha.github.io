...
layout: single
title: SPY vs DIVO
excerpt: SPY의 최근 8년 9개월 CAGR은 15.0%로 DIVO의 12.5%보다 2.6% 높았습니다.
header:
  overlay_color: "#333"
...
**수익률 지표 (CAGR):** SPY의 CAGR은 15.0%로 DIVO의 12.5%보다 2.6% 높았습니다. (높은 수익률)[^fn_vs_comp]
...
**위험도 지표 (표준편차):** 123% 투자 비중으로 표준편차를 비슷한 수준으로 맞추면, CAGR은 15.1%로 SPY의 15.0%와 비슷했습니다. (비슷한 수익률)
