...
layout: single
title: RSP vs SPY
excerpt: RSP의 최근 22년 3개월 CAGR은 10.9%로 SPY의 11.1%와 비슷했습니다.
header:
  overlay_color: "#333"
...
**수익률 지표 (CAGR):** RSP의 CAGR은 10.9%로 SPY의 11.1%와 비슷했습니다. (비슷한 수익률)[^fn_vs_comp]
...
**위험도 지표 (MDD):** 109% 투자 비중으로 하여 MDD를 비슷한 수준으로 맞추면, CAGR은 12.0%로 RSP의 10.9%보다 1.0% 높았습니다. (높은 수익률)
