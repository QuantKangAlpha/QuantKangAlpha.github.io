...
| :------------ | ------: | -----------: | -------: | ------: | -------: |
| JEPI | <span style="color: tomato">9.6<small>%</small></span> | 11.0<small>%</small> | 0.88 | -13.3<small>%</small> | -1.7<small>%</small> |
...
**위험도 지표 (표준편차):** 69% 투자 비중으로 표준편차를 비슷한 수준으로 맞추면, CAGR은 14.2%로 JEPI의 9.6%보다 4.5% 높았습니다. (높은 수익률)
