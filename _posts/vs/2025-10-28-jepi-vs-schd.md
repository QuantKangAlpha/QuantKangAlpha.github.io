...
| SCHD<sub>MDD</sub> <small>(81%)</small> | <span style="color: tomato">10.6<small>%</small></span> | 12.7<small>%</small> | 0.84 | -13.8<small>%</small> | -3.4<small>%</small> |



각각의 경우를 JEPI의 성과와 비교해 봅니다.

**위험도 지표 (표준편차):** 70% 투자 비중으로 표준편차를 비슷한 수준으로 맞추면, CAGR은 9.2%로 JEPI의 11.7%보다 -2.4% 낮았습니다. (낮은 수익률)

**위험도 지표 (MDD):** 81% 투자 비중으로 하여 MDD를 비슷한 수준으로 맞추면, CAGR은 10.6%로 JEPI의 11.7%보다 -1.0% 낮았습니다. (낮은 수익률)
...
이 포트폴리오는 JEPI의 11.7%보다 -1.7% 낮았습니다.
