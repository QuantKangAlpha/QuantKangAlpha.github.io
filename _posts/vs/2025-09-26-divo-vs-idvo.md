...
layout: single
title: DIVO vs IDVO
excerpt: DIVO의 최근 3년 CAGR은 13.7%로 IDVO의 20.7%보다 -7.0% 낮았습니다.
header:
  overlay_color: "#333"
...
**수익률 지표 (CAGR):** DIVO의 CAGR은 13.7%로 IDVO의 20.7%보다 -7.0% 낮았습니다. (낮은 수익률)[^fn_vs_comp]
...
| IDVO<sub>MDD</sub> <small>(78%)</small> | <span style="color: tomato">16.1<small>%</small></span> | 12.6<small>%</small> | 1.29 | -12.3<small>%</small> | -1.8<small>%</small> |



각각의 경우를 DIVO의 성과와 비교해 봅니다.

**위험도 지표 (표준편차):** 73% 투자 비중으로 표준편차를 비슷한 수준으로 맞추면, CAGR은 15.0%로 DIVO의 13.7%보다 1.2% 높았습니다. (높은 수익률)
