...
layout: single
title: GLD vs SPY
excerpt: GLD의 최근 20년 11개월 CAGR은 10.6%로 SPY의 10.8%와 비슷했습니다.
header:
  overlay_color: "#333"
...
**수익률 지표 (CAGR):** GLD의 CAGR은 10.6%로 SPY의 10.8%와 비슷했습니다. (비슷한 수익률)[^fn_vs_comp]
...
**위험도 지표 (MDD):** 83% 투자 비중으로 하여 MDD를 비슷한 수준으로 맞추면, CAGR은 9.1%로 GLD의 10.6%보다 -1.5% 낮았습니다. (낮은 수익률)
...
이 포트폴리오는 GLD의 10.6%보다 -1.0% 낮았습니다.
