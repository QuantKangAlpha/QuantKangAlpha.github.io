...
layout: single
title: IEF vs TLT
excerpt: IEF의 최근 24년 1개월 CAGR은 3.4%로 TLT의 3.5%와 비슷했습니다.
header:
  overlay_color: "#333"
...
**수익률 지표 (CAGR):** IEF의 CAGR은 3.4%로 TLT의 3.5%와 비슷했습니다. (비슷한 수익률)[^fn_vs_comp]
...
| TLT<sub>MDD</sub> <small>(49%)</small> | <span style="color: tomato">2.0<small>%</small></span> | 7.0<small>%</small> | 0.28 | -27.0<small>%</small> | -7.3<small>%</small> |
...
**위험도 지표 (MDD):** 49% 투자 비중으로 하여 MDD를 비슷한 수준으로 맞추면, CAGR은 2.0%로 IEF의 3.4%보다 -1.5% 낮았습니다. (낮은 수익률)
