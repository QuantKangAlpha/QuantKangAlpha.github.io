...
| AOR<sub>MDD</sub> <small>(215%)</small> | <span style="color: tomato">17.3<small>%</small></span> | 27.0<small>%</small> | 0.64 | -49.2<small>%</small> | -8.1<small>%</small> |
...
**위험도 지표 (MDD):** 215% 투자 비중으로 하여 MDD를 비슷한 수준으로 맞추면, CAGR은 17.3%로 PFF의 8.3%보다 9.0% 높았습니다. (높은 수익률)
