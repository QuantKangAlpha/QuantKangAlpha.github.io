...
layout: single
title: SDY vs SCHD
excerpt: SDY의 최근 13년 10개월 CAGR은 11.1%로 SCHD의 12.4%보다 -1.3% 낮았습니다.
header:
  overlay_color: "#333"
...
**위험도 지표 (표준편차):** SDY의 표준편차는 15.9%로 SCHD의 15.6%와 비슷했습니다. (비슷한 위험도)
...
**위험도 지표 (표준편차):** 표준편차를 동일한 값으로 맞추기 위해서는 15.6% / 15.9% = 103% 비중으로 투자하면 됩니다.[^fn_vs_sharpe]
