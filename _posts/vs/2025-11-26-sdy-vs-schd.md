...
| SCHD<sub>MDD</sub> <small>(110%)</small> | <span style="color: tomato">13.4<small>%</small></span> | 17.1<small>%</small> | 0.79 | -36.2<small>%</small> | -3.8<small>%</small> |



각각의 경우를 SDY의 성과와 비교해 봅니다.

**위험도 지표 (표준편차):** 102% 투자 비중으로 표준편차를 비슷한 수준으로 맞추면, CAGR은 12.6%로 SDY의 11.0%보다 1.5% 높았습니다. (높은 수익률)

**위험도 지표 (MDD):** 110% 투자 비중으로 하여 MDD를 비슷한 수준으로 맞추면, CAGR은 13.4%로 SDY의 11.0%보다 2.4% 높았습니다. (높은 수익률)
