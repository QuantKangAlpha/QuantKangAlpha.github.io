...
**위험도 지표 (표준편차):** 표준편차를 동일한 값으로 맞추기 위해서는 46.8% / 56.2% = 120% 비중으로 투자하면 됩니다.[^fn_vs_sharpe]
...
NVDA의 투자 비중을 조절하여 표준편차나 MDD를 동일하게 맞추면, CAGR이 평균 48.0%인 포트폴리오를 만들 수 있습니다.
이 포트폴리오는 NVDW의 41.3%보다 6.7% 높았습니다.
