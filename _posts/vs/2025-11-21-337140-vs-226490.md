...
| KODEX 코스피<sub>MDD</sub> <small>(98%)</small> | <span style="color: tomato">12.5<small>%</small></span> | 19.2<small>%</small> | 0.65 | -34.7<small>%</small> | -12.1<small>%</small> |
...
**위험도 지표 (MDD):** 98% 투자 비중으로 하여 MDD를 비슷한 수준으로 맞추면, CAGR은 12.5%로 KODEX 코스피대형주의 13.5%보다 -1.0% 낮았습니다. (낮은 수익률)
...
KODEX 코스피의 투자 비중을 조절하여 표준편차나 MDD를 동일하게 맞추면, CAGR이 평균 12.8%인 포트폴리오를 만들 수 있습니다.
