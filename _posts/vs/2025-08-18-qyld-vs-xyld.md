...
layout: single
title: QYLD vs XYLD
excerpt: QYLD의 최근 11년 8개월 CAGR은 7.3%로 XYLD의 6.9%와 비슷했습니다.
header:
  overlay_color: "#333"
...
**수익률 지표 (CAGR):** QYLD의 CAGR은 7.3%로 XYLD의 6.9%와 비슷했습니다. (비슷한 수익률)[^fn_vs_comp]
...
**위험도 지표 (표준편차):** 107% 투자 비중으로 표준편차를 비슷한 수준으로 맞추면, CAGR은 7.3%로 QYLD의 7.3%와 비슷했습니다. (비슷한 수익률)
