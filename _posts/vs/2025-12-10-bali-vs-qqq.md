...
| QQQ | <span style="color: tomato">29.8<small>%</small></span> | 20.4<small>%</small> | 1.46 | -22.8<small>%</small> | -3.0<small>%</small> |
...
**위험도 지표 (표준편차):** BALI의 표준편차는 13.3%로 QQQ의 20.4%보다 -7.1% 낮았습니다. (낮은 위험도)
...
**위험도 지표 (표준편차):** 표준편차를 동일한 값으로 맞추기 위해서는 20.4% / 13.3% = 65% 비중으로 투자하면 됩니다.[^fn_vs_sharpe]
...
| QQQ<sub>MDD</sub> <small>(73%)</small> | <span style="color: tomato">21.5<small>%</small></span> | 14.9<small>%</small> | 1.44 | -17.1<small>%</small> | -2.2<small>%</small> |



각각의 경우를 BALI의 성과와 비교해 봅니다.

**위험도 지표 (표준편차):** 65% 투자 비중으로 표준편차를 비슷한 수준으로 맞추면, CAGR은 19.0%로 BALI의 21.4%보다 -2.3% 낮았습니다. (낮은 수익률)
