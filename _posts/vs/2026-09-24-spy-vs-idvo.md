...
layout: single
title: SPY vs IDVO
excerpt: SPY의 최근 4년 CAGR은 19.1%로 IDVO의 20.7%보다 -1.6% 낮았습니다.
header:
  overlay_color: "#333"
...
**수익률 지표 (CAGR):** SPY의 CAGR은 19.1%로 IDVO의 20.7%보다 -1.6% 낮았습니다. (낮은 수익률)[^fn_vs_comp]

**위험도 지표 (표준편차):** SPY의 표준편차는 15.9%로 IDVO의 16.2%와 비슷했습니다. (비슷한 위험도)
...
**위험도 지표 (표준편차):** 표준편차를 동일한 값으로 맞추기 위해서는 16.2% / 15.9% = 98% 비중으로 투자하면 됩니다.[^fn_vs_sharpe]
