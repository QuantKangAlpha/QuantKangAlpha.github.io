...
excerpt: KIWOOM 미국달러SOFR금리액티브(합성) (460270)의 최근 2년 2개월 CAGR은 9.2%로 PLUS 미국달러SOFR금리액티브(합성) (456200)의 9.2%와 비슷했습니다.
header:
  overlay_color: "#333"
...
**수익률 지표 (CAGR):** KIWOOM 미국달러SOFR금리액티브(합성)의 CAGR은 9.2%로 PLUS 미국달러SOFR금리액티브(합성)의 9.2%와 비슷했습니다. (비슷한 수익률)[^fn_vs_comp]
...
| PLUS 미국달러SOFR금리액티브(합성)<sub>MDD</sub> <small>(94%)</small> | <span style="color: tomato">8.7<small>%</small></span> | 8.3<small>%</small> | 1.04 | -8.0<small>%</small> | -1.9<small>%</small> |



각각의 경우를 KIWOOM 미국달러SOFR금리액티브(합성)의 성과와 비교해 봅니다.

**위험도 지표 (표준편차):** 103% 투자 비중으로 표준편차를 비슷한 수준으로 맞추면, CAGR은 9.5%로 KIWOOM 미국달러SOFR금리액티브(합성)의 9.2%와 비슷했습니다. (비슷한 수익률)

**위험도 지표 (MDD):** 94% 투자 비중으로 하여 MDD를 비슷한 수준으로 맞추면, CAGR은 8.7%로 KIWOOM 미국달러SOFR금리액티브(합성)의 9.2%와 비슷했습니다. (비슷한 수익률)
