...
| TLT<sub>MDD</sub> <small>(136%)</small> | <span style="color: tomato">3.8<small>%</small></span> | 20.7<small>%</small> | 0.18 | -60.1<small>%</small> | -20.0<small>%</small> |
...
**위험도 지표 (MDD):** 136% 투자 비중으로 하여 MDD를 비슷한 수준으로 맞추면, CAGR은 3.8%로 PFF의 3.9%와 비슷했습니다. (비슷한 수익률)
