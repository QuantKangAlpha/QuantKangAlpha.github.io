...
layout: single
title: VIG vs SCHD
excerpt: VIG의 최근 14년 CAGR은 12.9%로 SCHD의 12.1%와 비슷했습니다.
header:
  overlay_color: "#333"
...
**위험도 지표 (표준편차):** 98% 투자 비중으로 표준편차를 비슷한 수준으로 맞추면, CAGR은 11.8%로 VIG의 12.9%보다 -1.0% 낮았습니다. (낮은 수익률)

**위험도 지표 (MDD):** 95% 투자 비중으로 하여 MDD를 비슷한 수준으로 맞추면, CAGR은 11.5%로 VIG의 12.9%보다 -1.3% 낮았습니다. (낮은 수익률)
