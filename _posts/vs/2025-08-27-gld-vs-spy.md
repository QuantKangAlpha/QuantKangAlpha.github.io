...
layout: single
title: GLD vs SPY
excerpt: GLD의 최근 20년 9개월 CAGR은 9.9%로 SPY의 10.5%와 비슷했습니다.
header:
  overlay_color: "#333"
...
**위험도 지표 (표준편차):** 92% 투자 비중으로 표준편차를 비슷한 수준으로 맞추면, CAGR은 9.8%로 GLD의 9.9%와 비슷했습니다. (비슷한 수익률)

**위험도 지표 (MDD):** 83% 투자 비중으로 하여 MDD를 비슷한 수준으로 맞추면, CAGR은 8.9%로 GLD의 9.9%와 비슷했습니다. (비슷한 수익률)
