...
excerpt: PLUS 미국달러SOFR금리액티브(합성) (456200)의 최근 2년 2개월 CAGR은 7.5%로 TIGER 미국달러SOFR금리액티브(합성) (456610)의 7.2%와 비슷했습니다.
header:
  overlay_color: "#333"
...
| :------------ | ------: | -----------: | -------: | ------: | -------: |
| PLUS 미국달러SOFR금리액티브(합성) | <span style="color: tomato">7.5<small>%</small></span> | 8.8<small>%</small> | 0.85 | -8.5<small>%</small> | -2.0<small>%</small> |
...
**수익률 지표 (CAGR):** PLUS 미국달러SOFR금리액티브(합성)의 CAGR은 7.5%로 TIGER 미국달러SOFR금리액티브(합성)의 7.2%와 비슷했습니다. (비슷한 수익률)[^fn_vs_comp]
...
**위험도 지표 (표준편차):** 100% 투자 비중으로 표준편차를 비슷한 수준으로 맞추면, CAGR은 7.2%로 PLUS 미국달러SOFR금리액티브(합성)의 7.5%와 비슷했습니다. (비슷한 수익률)

**위험도 지표 (MDD):** 104% 투자 비중으로 하여 MDD를 비슷한 수준으로 맞추면, CAGR은 7.5%로 PLUS 미국달러SOFR금리액티브(합성)의 7.5%와 비슷했습니다. (비슷한 수익률)
