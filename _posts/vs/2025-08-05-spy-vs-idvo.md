...
layout: single
title: SPY vs IDVO
excerpt: SPY의 최근 2년 10개월 CAGR은 18.5%로 IDVO의 17.9%와 비슷했습니다.
header:
  overlay_color: "#333"
...
**수익률 지표 (CAGR):** SPY의 CAGR은 18.5%로 IDVO의 17.9%와 비슷했습니다. (비슷한 수익률)[^fn_vs_comp]
...
| IDVO<sub>MDD</sub> <small>(121%)</small> | <span style="color: tomato">21.7<small>%</small></span> | 19.8<small>%</small> | 1.10 | -18.5<small>%</small> | -3.0<small>%</small> |



각각의 경우를 SPY의 성과와 비교해 봅니다.

**위험도 지표 (표준편차):** 105% 투자 비중으로 표준편차를 비슷한 수준으로 맞추면, CAGR은 18.8%로 SPY의 18.5%와 비슷했습니다. (비슷한 수익률)

**위험도 지표 (MDD):** 121% 투자 비중으로 하여 MDD를 비슷한 수준으로 맞추면, CAGR은 21.7%로 SPY의 18.5%보다 3.2% 높았습니다. (높은 수익률)
...
이 포트폴리오는 SPY의 18.5%보다 1.8% 높았습니다.
