...
layout: single
title: QDTE vs IQQQ
excerpt: QDTE의 최근 2년 6개월 CAGR은 21.6%로 IQQQ의 18.5%보다 3.2% 높았습니다.
header:
  overlay_color: "#333"
...
**수익률 지표 (CAGR):** QDTE의 CAGR은 21.6%로 IQQQ의 18.5%보다 3.2% 높았습니다. (높은 수익률)[^fn_vs_comp]
...
**위험도 지표 (표준편차):** 표준편차를 동일한 값으로 맞추기 위해서는 19.0% / 18.9% = 100% 비중으로 투자하면 됩니다.[^fn_vs_sharpe]
...
**위험도 지표 (표준편차):** 100% 투자 비중으로 표준편차를 비슷한 수준으로 맞추면, CAGR은 18.4%로 QDTE의 21.6%보다 -3.2% 낮았습니다. (낮은 수익률)

**위험도 지표 (MDD):** 112% 투자 비중으로 하여 MDD를 비슷한 수준으로 맞추면, CAGR은 20.6%로 QDTE의 21.6%보다 -1.0% 낮았습니다. (낮은 수익률)
...
이 포트폴리오는 QDTE의 21.6%보다 -2.1% 낮았습니다.
