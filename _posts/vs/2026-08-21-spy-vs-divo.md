...
layout: single
title: SPY vs DIVO
excerpt: SPY의 최근 9년 8개월 CAGR은 15.2%로 DIVO의 13.0%보다 2.3% 높았습니다.
header:
  overlay_color: "#333"
...
**수익률 지표 (CAGR):** SPY의 CAGR은 15.2%로 DIVO의 13.0%보다 2.3% 높았습니다. (높은 수익률)[^fn_vs_comp]
...
**위험도 지표 (표준편차):** 123% 투자 비중으로 표준편차를 비슷한 수준으로 맞추면, CAGR은 15.9%로 SPY의 15.2%와 비슷했습니다. (비슷한 수익률)

**위험도 지표 (MDD):** 112% 투자 비중으로 하여 MDD를 비슷한 수준으로 맞추면, CAGR은 14.5%로 SPY의 15.2%와 비슷했습니다. (비슷한 수익률)
